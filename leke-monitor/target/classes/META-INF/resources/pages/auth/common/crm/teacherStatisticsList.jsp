				...
				<div class="m-search-box f-pt15">
					<form id="form">
						<div class="f-mb20 borderbottm">
							<label for="" class="title f-ml25">学校名称：</label> <label for="" class="title">${schoolName }</label>
						</div>
...
<script type="text/javascript">
	window.subjectStr = ${subjectStr};
	window.gradeStr = ${gradeStr};
	window.classStatistics = ${classStatistics};
	seajs.use('monitor/pages/common/crm/teacherStatistics');
</script>
</html>