			...
			<div class="z-statisticalcenter">
				<div class="m-search-box f-pt15">
					<form id="form">
						...
						<input class="u-ipt u-ipt-nm" type="text" name="loginName" id="loginName" />
...
window.data={
	...
	seajs.use('monitor/pages/common/crm/leader/schoolleaderList');
</script>
</html>