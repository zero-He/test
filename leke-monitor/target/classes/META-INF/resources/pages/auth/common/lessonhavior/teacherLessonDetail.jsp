		...
		<div class="m-search-box">
                        <div class="item">
                            <p class="lm-textpane">
                            	...
                            	<span>年级： <em id="gradeName">${query.gradeName}</em></span>
                               	<span>学科： <em id="subjectName">${query.subjectName}</em></span>
                                <span>老师： <em id="teacherName">${query.teacherName}</em></span>
                            </p>
                        </div>
						<div class="item">
							<label>统计时间：</label> 
...
<script>
	seajs.use('monitor/pages/common/lessonhavior/teacherLessonDetail');
</script>
