...
"></i>
					<div class="f-fr  m-btns f-mr10">
						<!-- <select id="changeTable" class="sel"
								data-bind="options:state,
                                                       optionsText:'name',
                                                       optionsValue:'id',
                                                       value:stateChange">
							</select> -->
				...
				<div class="m-table m-table-center f-mb0 classdetail">
					<table>
						<tr>
							...
							<th width="12%" colspan="3">微课(课前)</th>
							<!-- /ko -->
							<!-- ko if: stateChange() == 2 -->
						...
						<tbody id="papersPage" data-bind="foreach:listdata">
							<tr>
								...
								<!-- /ko -->
								<td><a class="f-csp s-c-turquoise" data-bind="click:$parent.opendetail.bind($data)">详情</td>
...
<script>
	seajs.use('monitor/pages/common/beike/schoolbeikeStatisView');
</script>
