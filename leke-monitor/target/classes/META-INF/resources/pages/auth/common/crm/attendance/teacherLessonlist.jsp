		...
		<div class="z-statisticalcenter">
			<div class="m-search-box f-pt15">
				<div class="f-mb20 borderbottm">
					<label for="" class="title">班主任：</label>
					<label for="" class="title">${query.headTeacherName}</label>
					...
					<table>
						...
						<tbody id="papersPage" data-bind="foreach:listdata">
							<tr>
								...
								<td><em data-bind="text:lessonMinutes"></em></td>
								<td><em data-bind="text:lessonName"></em></td>
								<td><em data-bind="text:attendTimeStr"></em></td>
...
<script>
	...
	seajs.use('monitor/pages/common/crm/attendance/teacherLessonlist');
</script>
