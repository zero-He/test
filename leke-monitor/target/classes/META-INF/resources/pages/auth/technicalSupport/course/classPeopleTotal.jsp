	...
	<div data-bind="component: {
		...
		params: {
			options: {
				...
				postUrl:'/auth/technicalSupport/course/dailyCourseStats.htm',
				urlView:'/auth/technicalSupport/course/classPeopleView.htm',
				exportUrl:'/auth/technicalSupport/course/exportDailyCourseStats.htm'
			}
		}
	}"></div>
	</div>
...
<script>
	seajs.use('monitor/pages/technicalSupport/course/classPeopleTotal');
</script>
</body>
</html>