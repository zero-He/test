define(function(require,exports,module){
	...
	var SsChart = {
			...
			fLoadSsForTimeChart : function() {
				...
				var schoolIds = $('#jSchoolIds').val();
				$.ajax({
					type : 'post',
					url : ctx + '/auth/educationDirector/school/loadSchoolStatisForTimeChart.htm',
					data : {
						'startStr' : startStr,
						'endStr' : endStr,
						'schoolIdsStr' : schoolIds,
					},
					dataType : 'json',
					async : true,
					success : function(json) {
						...
						_this.fShowChart('time', 'jTimeSchool','', monArr, schArr, '学校', 'schoolListByTime.htm?schoolIdsStr='+schoolIds+'&timeStr=');
						_this.fShowChart('time', 'jTimeTeacher','', monArr, tchArr, '教师', 'schoolUserListByTime.htm?schoolIdsStr='+schoolIds+'&roleId=101&timeStr=');
						_this.fShowChart('time', 'jTimeStudent','', monArr, stuArr, '学生', 'schoolUserListByTime.htm?schoolIdsStr='+schoolIds+'&roleId=100&timeStr=');
					}
				});
			}, 
			...
			fLoadSsForAreaChart : function() {
				...
				$.ajax({
					type : 'post',
					url : ctx + '/auth/educationDirector/school/loadSchoolStatisForAreaChart.htm',
					data : {
						'areasStr' : areasStr
					},
					dataType : 'json',
