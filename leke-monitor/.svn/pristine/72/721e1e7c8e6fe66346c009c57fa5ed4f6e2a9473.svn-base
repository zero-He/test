...
<div class="g-bd"> 
  ...
  <div class="g-mn" id="g-mn" data-bind="component: {
		...
		params: {
			options:{
				schoolId:${schoolId},
				postUrl:'/auth/technicalSupport/course/findCourseSingleByQuery.htm',
				exportUrl:'/auth/technicalSupport/course/exportCourseSingleByQuery.htm'
			}
		}
	}">	
	</div>
...
<script>
  	seajs.use('monitor/pages/technicalSupport/course/classPeopleView');
</script>
</body>
</html>