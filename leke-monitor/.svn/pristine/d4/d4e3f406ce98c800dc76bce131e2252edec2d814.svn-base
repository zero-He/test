...
public class WorkStatisticsController
{
			...
			throws Exception
	{
		...
		String[] headers =
		{ "学校名称", "学段", "所属市场", "注册用户数","注册学生数","注册老师数","注册家长数", "作业系统新增学生数", "新增购课人数" };
		String[] fieldNames =
		{ "schoolName", "schoolStageName", "marketName", "allUserNum","studentNum","teacherNum","parentNum", "workStudentNum", "buyNum" };
