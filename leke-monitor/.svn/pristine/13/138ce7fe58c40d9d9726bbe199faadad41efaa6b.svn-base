				...
				<div class="m-search-box f-pt15">
					<form id="form">
						<div class="f-mb20 borderbottm">
							...
							<label for="" class="title">客户经理：</label> <label for="" class="title">${sellerName }</label> <label for="" class="title">学段：</label> <label
								for="" class="title">${schoolStageName }</label> <label for="" class="title f-ml25">学校名称：</label> <label for="" class="title">${schoolName }</label>
						</div>
...
<script type="text/javascript">
	...
	seajs.use('monitor/pages/common/crm/leader/leaderStudent');
</script>
</html>