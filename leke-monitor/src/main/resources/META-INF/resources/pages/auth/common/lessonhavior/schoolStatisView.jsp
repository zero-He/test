		...
		<form action="" method="post">
			<div class="m-search-box">
				<div class="item">
					...
					<label class="f-ml10">学校名称：</label> 
					<input type="text" value=""class="u-ipt u-ipt-nm" id="schoolName"> 
					<label class="f-ml10">学段：</label>
					<select class="u-select u-select-nm" id="stage">
				...
				<div class="m-table m-table-center">
					<table>
						<tr>
							<th width="13.5%">学校</th>
							<th width="13.5%">学段</th>
							<th width="13.5%">上课课堂数</th>
							<th width="13.5%">发起次数</th>
							<th width="14%">平均发起次数/课</th>
							<th width="13.5%">发起率</th>
							<th>操作</th>
						</tr>
						<tbody id="papersPage" data-bind="foreach:listdata">
							<tr>
								...
								<a class="f-csp s-c-turquoise" data-bind="click:$parent.openteacher.bind($data)">老师统计</a>
								</td>
							</tr>
						</tbody>
					</table>
...
<script>
	seajs.use('monitor/pages/common/lessonhavior/schoolStatisView');
</script>
