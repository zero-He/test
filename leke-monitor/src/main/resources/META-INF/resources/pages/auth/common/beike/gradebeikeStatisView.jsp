	...
	<div class="g-mn">
		<div class="z-statisticalcenter">
			<div class="m-search-box f-pt15">
				...
				<select id="gradeId" name="gradeId" class="u-select u-select-nm"
					data-bind="options:gradeOption,
                                                       optionsText:'gradeName',
                                                       optionsValue:'gradeId',
                                                       optionsCaption:'==请选择=='">
				</select>
				<label for class="title">学科：</label>
				<select id="subjectId" name="subjectId" class="u-select u-select-nm"
					data-bind="options:subjectOption,
				...
				<div class="m-table m-table-center f-mb0 classdetail">
					<table>
						<tr>
							...
							<th width="16%" colspan="4">备课包</th>
							<!-- ko if: stateChange() == 1 -->
							<th width="16%" colspan="4">课件(课前)</th>
							<th width="16%" colspan="4">作业(课前)</th>
							<th width="13%" colspan="3">微课(课前)</th>
							<!-- /ko -->
							<!-- ko if: stateChange() == 2 -->
							<th width="28%" colspan="4">课件(课中)</th>
							<th width="28%" colspan="4">作业(课中)</th>
							<!-- /ko -->
							<!-- ko if: stateChange() == 3 -->
							<th width="16%" colspan="4">作业(课后)</th>
							<th width="12%" colspan="3">微课(课后)</th>
							<!-- /ko -->
						</tr>
						<tr>
							<td width="7%"></td>
...
<script>
	seajs.use('monitor/pages/common/beike/gradebeikeStatisView');
</script>
