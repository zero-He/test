 ...
 *
 * @author  liulb
 * @created 2014年5月9日 下午2:46:09
 * @since   v1.0.0
 */
public interface QuestionOfficialTagDao {
	 ...
	 * @return int
	 */
	int insertQuestionOfficialTag(QuestionOfficialTag assoc);
	 ...
	 * @return int
	 */
	int deleteQuestionOfficialTag(QuestionOfficialTag assoc);
	 ...
	 * @return int
	 */
	int deleteQuestionOfficialTagByQuestionId(Long questionId);
