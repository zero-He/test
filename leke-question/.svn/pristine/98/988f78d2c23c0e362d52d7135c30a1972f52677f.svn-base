...
@Controller
@RequestMapping("/auth/researcher/workbook/leke/share")
public class ResearcherLekeShareWorkbookController {
	@Resource
	...
	public JsonResult details(RepositoryWorkbookQuery query, Page page) {
		...
		query.setShareScope(ShareScopes.LEKE_SHARE);
		List<RepositoryRecord> records = workbookService.queryLekeShareWorkbooks(query, page);
