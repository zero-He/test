...
<link rel="stylesheet" type="text/css" href="${assets}/styles/common/global.css?t=${_t}">
	...
	<div class="z-resource">
		...
		<div class="resourcecontent">
			<div class="left" data-bind="component:{
				...
				params: {resType: resType,shareScope: shareScope,feedbackScope: feedbackScope,userResGroupId: userResGroupId,delUserResGroup: delUserResGroup,isShare: isShare}
			}"></div>
			<!-- ko if: !isShare() -->
...
seajs.use('question/pages/teacher/question/personal/list');
</script>
</body>
</html>