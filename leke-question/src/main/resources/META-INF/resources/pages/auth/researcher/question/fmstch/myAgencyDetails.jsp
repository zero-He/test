			...
			<tr class="item" data-question-id="${record.resId}" data-question-type-id="${record.questionTypeId}">
				...
				<td width="260">
					<div class="c-maxoperationlistbtn">
						...
						<a target="_blank"
							href="${initParam.questionServerName}/auth/common/question/view.htm?questionId=${record.resId}&curScope=8&action=override&curFmsTchId=${record.attrs.assoc.teacherId}" title="查看">
							<i class="see"></i>
						</a>
						<i class="edit j-edit" title="编辑"
							data-url="${initParam.questionServerName}/auth/common/question/questionEdit.htm?questionId=${record.resId}&curScope=8&action=override&curFmsTchId=${record.attrs.assoc.teacherId}&crossDomain=true"></i>
						</c:if>
					</div>
				</td>
			</tr>
