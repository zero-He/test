...
<c:if test="${not empty records}">
	<table class="c-exercisestable">
		<tbody>
			...
			<tr class="item" data-question-id="${record.resId}" data-teacher-id="${record.attrs.assoc.teacherId}" >
				...
				<td width="290">
					<div class="c-maxoperationlistbtn">
						...
						<a href="${ctx}/auth/common/question/view.htm?questionId=${record.resId}&curScope=9" target="_blank" tilte="查看"><i class="see" ></i></a>
						<i class="move j-removeFmTch" title="移除"></i>
					</div>
				</td>
			</tr>
			</c:forEach>
