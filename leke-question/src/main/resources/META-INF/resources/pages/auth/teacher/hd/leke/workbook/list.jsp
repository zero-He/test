			...
			<form action="" method="post" id="Jform">
				<div class="c-condition">
					...
					<!-- <div class="resouceselect">
							<div class="text">我的资源</div>
							<div class="c-droplist" style="display: none;">
								<ul>
									<li class="item cur">我的资源</li>
									<li class="item">我的收藏</li>
									<li class="item">我的分享</li>
								</ul>
							</div>
						</div> -->	
						<div class="searchcon">
							<div id="search" class="search" style="display:none">
								<div class="c-search">
									<input type="text" placeholder="请输入名称或内容" name="content"> <span
										class="del mydel">×</span> <span class="searchbtn myserch"> <i></i></span>
								</div>
...
{{#dataList}}
           <li class="item">
                     ...
                     <div class="info">
                         <div class="title mx" data-id="{{workbookId}}">{{workbookName}}</div>
                         <div class="operation" data-id="{{workbookId}}">
							<span class="nocollect sc"><i></i>收藏：<em>{{favCount}}</em></span> 
							<span class="praise dz"><i></i>赞：<em>{{praiseCount}}</em></span>
						</div>
...
<script src="/scripts/question/pages/teacher/hd/leke/workbook/list.js"></script>
