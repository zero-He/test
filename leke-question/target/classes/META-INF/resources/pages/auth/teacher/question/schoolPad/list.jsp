            ...
            <div class="c-condition">
           		<div class="condition">
                    <div class="resouceselect">
                        <div class="text j-scope-cur">全部</div>
                        <div class="c-droplist">
                            <ul class="j-scope" style="display: none;">
                                <li class="item cur" data-source-type="">全部</li>
                                <li class="item" data-source-type="1">我的代录</li>
                            </ul>
                        </div>
                    </div>
                    <div class="searchcon">
...
<script type="text/javascript" src="/scripts/question/pages/teacher/question/schoolPad/list.js"></script>
</html>