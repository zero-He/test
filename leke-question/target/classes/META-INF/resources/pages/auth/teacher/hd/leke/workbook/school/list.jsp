           ...
           <li class="item">
			...
			<img src="{{photoUrl}}" alt="{{workbookName}}">
                     ...
                     <div class="info">
						...
						<!--  	 <span class="rename cmm"><i></i>重命名<em></em></span>
							 <span class="edit bj"><i></i>编辑<em></em></span> -->
						 </div>
...
<script src="/scripts/question/pages/teacher/hd/leke/workbook/school/list.js"></script>
