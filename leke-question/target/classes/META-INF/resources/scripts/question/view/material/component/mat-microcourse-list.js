define(function(require,exports,module){
	...
	var LOAD_DIR = Leke.domain.repositoryServerName +  '/auth/admin/jsonp/leke/microcourse/details.htm';
	var COPY_DIR = Leke.domain.beikeServerName +  '/auth/common/microcourse/jsonp/doAddSection.htm';
	...
	ListVM.prototype.open = function($data){
		window.open(Leke.domain.beikeServerName + '/auth/common/microcourse/preview.htm?microcourseId=' + $data.resId);
	};
	...
	ko.components.register('mat-microcourse-list', {
