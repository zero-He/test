...
public interface HomeworkService {
	 ...
	 * @return
	 */
	public List<Homework> findLessonWorkByLessonId(Long teacherId, Long lessonId, Integer resTyp);
	...
	/**
	 * @param lessonIds
	 * @param usePhase 使用阶段 1 ： 课前  2：课中3：课后
	 * @return
	 */
	List<LessonResInfo> findLessonResInfos(Long studentId, List<Long> lessonIds, Integer usePhase);
	 ...
	 * @return
	 */
	List<Homework> findAfterHwByLessonId(Long teacherId, Long lessonId);
}
