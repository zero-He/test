...
;(function ($, window, document) {
    ...
    Indicator.prototype = {
        ...
        value: function (val) {
            ...
            var my_gradient=ctx.createLinearGradient(112,6,112,70);
            my_gradient.addColorStop(0,"#fc5e53");
            my_gradient.addColorStop("0.5","#2dafa5");
            my_gradient.addColorStop(1,"#2dafa5");
