...
<body id="jDroploadId">
    ...
    <script src="/scripts/m/homework/school/provost-worklist.js?_tt=20171115"></script>
	<!--模态层-->
	<article class="modal-body">
		...
		<article class="modal-box">
			<section class="main">
				<!--年级-->
				<ul class="main-list main-list-auto main-list-grade">
					<h3 class="tit">年级<i class="pull-icon"></i></h3>
					<div class="grade-context"></div>
					<script id="gradeContext_tpl" type="text/x-handlebars-template">
						{{#gradeList}}
						<li class="item" data-gradeid = "{{gradeId}}">
							<p>
								{{gradeName}}
							</p>
						</li>
