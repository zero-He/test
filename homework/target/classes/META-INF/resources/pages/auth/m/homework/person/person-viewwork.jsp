...
<script type="text/javascript" src="${assets}/scripts/common/mobile/iscroll-zoom.min.js?_t=20171115"></script>
<script type="text/javascript" src="${ctx}/scripts/m/homework/person/person-viewwork.webapi.js?_t=${_ts}"></script>
<script type="text/javascript" src="${ctx}/scripts/m/homework/person/person-viewwork.bundle.js?_t=${_ts}"></script>
</body>
</html>
