...
<head>
	...
	<title>国庆活动首页</title>
	<link rel="stylesheet" href="${assets}/styles/common/global.css?t=20171115">
	<link rel="stylesheet" href="${assets}/pages/activity/2017-9-21/styles/style.css?t=20171115">
	<script>
		var remove_ul = false;
		(function() {
