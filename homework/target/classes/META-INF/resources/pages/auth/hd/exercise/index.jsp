...
<link rel="stylesheet" type="text/css" href="${assets}/styles/mobile/learn-pad.css?t=20171115">
<style>
.content {
  height: 360px;
  overflow: hidden;
...
<script src="/scripts/hd/exercise/index.js?_t=20171115"></script>
<script src="/scripts/hd/exercise/scrolling.js?_t=20171115"></script>
</body>
</html>