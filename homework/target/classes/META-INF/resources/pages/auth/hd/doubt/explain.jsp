...
<%@ include file="/pages/common/tags.jsp"%>
	<style type="text/css">
                    ...
                    <div class="formbox">
                        ...
                        <c:if test="${currentRoleId==101}">
	                        <div class="choose c-arrow" id="j-choose-version">
	                            	教材版本信息 <span data-a="${doubt.pressId }" data-b="${doubt.materialId}" data-c="${doubt.materialNodeId}" data-d="${doubt.materialNodeId}" class="version-result">${doubt.materialPathName}</span>
	                        </div>
                        </c:if>
        ...
        <!-- 选择教材版本信息 -->
        <div class="c-choose-version c-hidden j-choose-version" data-v="hd" data-i="${doubt.schoolStageId}">
            <div class="inner">
	...
	<script src="/scripts/m/p/doubt/explain.js?_tt=20171115"></script>