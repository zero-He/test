...
public interface HomeworkDao {
	 ...
	 * @return
	 */
	public Homework getHomeworkByBeikeGuid(@Param("beikeGuid") String beikeGuid, @Param("lessonId") Long lessonId);
	 ...
	 * @return
	 */
	public int updateHomeworkUsePhase(Homework homework);
	...
	List<Long> findPreHwIdsByLesson(@Param("lessonId") Long lessonId);
	
	List<Homework> findAfterHwByLessonId(@Param("teacherId") Long teacherId, @Param("lessonId") Long lessonId);
	 ...
	 * @param usePhase
	 */
	void delLessonResource(@Param("lessonId") Long lessonId,@Param("guid") String guid, @Param("usePhases")  List<Integer> usePhases);
}
