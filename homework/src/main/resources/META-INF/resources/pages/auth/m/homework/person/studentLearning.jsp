...
<script src="${assets}/scripts/common/mobile/ui/ui-coursewarePreview/ui-coursewarePreview.js?_t=${_t}"></script>
<script src="/scripts/m/homework/person/studentLearning.js?_t=${_t}"></script>
</body>
</html>
