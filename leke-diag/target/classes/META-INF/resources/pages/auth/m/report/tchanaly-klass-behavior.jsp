...
<script type="text/javascript" src="${ctx}/scripts/m/diag/report/tchanaly-klass-behavior.webapi.js"></script>
<script type="text/javascript" src="${ctx}/scripts/m/diag/report/tchanaly-klass-behavior.bundle.js"></script>
</body>
</html>