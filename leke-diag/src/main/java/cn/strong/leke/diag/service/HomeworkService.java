...
public class HomeworkService {
	...
	public List<AnalysePhase> findAnalysePhasesByBeikeGuid(String beikeGuid) {
		return this.homeworkDao.findAnalysePhasesByBeikeGuid(beikeGuid);
	}
	 ...
	 * @return
	 */
	public List<LessonExamAnaly> findExamScoreByLessonIdAndUsePhase(Long courseSingleId, Integer usePhase) {
		List<LessonExamAnaly> exams = this.homeworkDao.findExamScoreByLessonIdAndUsePhase(courseSingleId, usePhase);
		exams.forEach(v -> {
