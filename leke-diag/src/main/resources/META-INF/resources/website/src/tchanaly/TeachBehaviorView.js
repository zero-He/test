...
class BeikeInfo extends React.Component {
	...
	render() {
		...
		return (
            <Section id={this.props.id} title="备课">
...
class EvaluateInfo extends React.Component {
	...
	render() {
		...
		return (
            <Section id={this.props.id} title="课堂评价">
                <div className="con">
...
class InteractInfo extends React.Component {
	render() {
		...
		return (
			<Section id={this.props.id} title="课堂互动">
...
class WorkFinishInfo extends React.Component {
	render() {
		...
		return (
			<Section id={this.props.id} title="作业批改" help={`${Leke.domain.staticServerName}/pages/help-center/diag/zy-pg.html`}>
...
class AttendInfo extends React.Component {
	render() {
		...
		return (
			<Section id={this.props.id} title="考勤" help={`${Leke.domain.staticServerName}/pages/help-center/diag/kq-gz.html`}>
