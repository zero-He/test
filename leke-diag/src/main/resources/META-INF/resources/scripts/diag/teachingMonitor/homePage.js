define(function(require, exports, module) {
	...
	var Statistics = {
			...
			bindEvent : function(){
				...
				$(document).on("click", "#scheduleDate",function(){
					WdatePicker({
						dateFmt : 'yyyy-MM-dd',
				...
				$(document).on("click", "#scheduleToday", function(){
				...
				$(document).on("click", "#scheduleDatelt", function(){
				...
				$(document).on("click", "#scheduleDategt", function(){
				...
				$(document).on("click", "#dynamicDate",function(){
					WdatePicker({
						dateFmt : 'yyyy-MM-dd',
						maxDate : HandleCommParam.getCurrentDate(),
						readOnly : true,
				...
				$(document).on("click", "#dynamicToday", function(){
				...
				$(document).on("click", "#dynamicDatelt", function(){
					$("#dynamicDate").html(HandleCommParam.getDateByDelta($("#dynamicDate").html(), -1));
					$("#dynamicToday").addClass("c-dateswitch__gotoday--not");
					Statistics.loadDynamicData({startDate:$("#dynamicDate").html(), endDate:$("#dynamicDate").html()});
				});
				
				$(document).on("click", "#dynamicDategt", function(){
				...
				$(document).on("click", "[name='lessonStatusChk']",function(){
					var arr = [];
				...
				$(document).on("click", "[name='isPreparedChk']",function(){
					var arr = [];
				...
				$(document).on("click", ".iconItem", function(){
					Dialog.open({
						title: "帮助",
						tpl: dialogHelp,
						size: 'nm',
